    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div
            ...
            <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
                <h1 class="sitename">Kost 2024</h1>
            </a>
            <nav id="navmenu" class="navmenu">
                <ul>
                    <li><a href="#hero" class="active">Home</a></li>
                    <li><a href="#features">Kost</a></li>
    ...
    <main class="main">
                    ...
                    <div class="col-lg-6">
                        <div class="hero-content" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <h1 class="mb-4">
                                Kost <br>
                                2024 <br>
                                <span class="accent-text">Yogyakarta Indonesia</span>
                            </h1>
        ...
        <section id="features" class="features section">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>Kost</h2>
                <p>Kami menyediakan kost dengan fasilitas lengkap</p>
                    ...
                    @foreach ($kosts as $kost)
                        <div class="col-xl-3 col-md-6" data-aos="zoom-in" data-aos-delay="100">
                            <div class="feature-box">
                              <img src="https://static.vecteezy.com/system/resources/previews/008/533/393/non_2x/ad-artistic-letter-logo-design-with-serif-font-in-black-and-white-colors-illustration-vector.jpg" width="100%" height="50%" alt="" class="mb-2">
                                {{-- <i class="bi bi-award"></i> --}}
                                <h4>{{ $kost->nama_kost }}</h4>
                                <p>Rp. {{ $kost->fasilitas_kost }}</p>
                                <p class="text-danger">Rp. {{ number_format($kost->harga_kost) }}</p>
                                <button class="btn btn-primary mt-2">Sewa Sekarang</button>
                            </div>
                        </div>
                    @endforeach
                </div>
